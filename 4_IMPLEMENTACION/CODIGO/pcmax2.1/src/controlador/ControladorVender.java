...
import datasource.InventarioDataSource;
import datasource.VentasDataSource;
import modelo.DetalleVender;
import modelo.Producto;
import modelo.Vender;
import modules.inventario.SeleccionarProductoController;
import utils.ticket.GeneraTicket;
import dialog.*;
 ...
 * 
 */
public class ControladorVender extends BorderPane {
    ...
    @FXML
    TableView<DetalleVender> tablaDetallesVenta;
    @FXML
    TableColumn<DetalleVender, Integer> ClaveCol;
    @FXML
    TableColumn<DetalleVender, String> DescripcionCol;
    @FXML
    TableColumn<DetalleVender, Float> precioUnitarioCol;
    @FXML
    TableColumn<DetalleVender, Integer> cantidadCol;
    @FXML
    TableColumn<DetalleVender, Float> importeCol;
    //necesary vars
    private Vender nuevaVenta = new Vender();
    ...
    public ControladorVender(String vendedor, double ancho, double alto) {
        ...
        //check for caja
        //set columns
        ClaveCol.setCellValueFactory(new PropertyValueFactory<DetalleVender, Integer>("idProducto"));
        DescripcionCol.setCellValueFactory(new PropertyValueFactory<DetalleVender, String>("concepto"));
        precioUnitarioCol.setCellValueFactory(new PropertyValueFactory<DetalleVender, Float>("precioUnit"));
        cantidadCol.setCellValueFactory(new PropertyValueFactory<DetalleVender, Integer>("cantidad"));
        importeCol.setCellValueFactory(new PropertyValueFactory<DetalleVender, Float>("importe"));
        //set table content
        cargarDatosTabla();
    ...
    private void AgregarProducto(String codigo, int cantidad) {
        ...
        DetalleVender nuevoDetalle = new DetalleVender();
    ...
    private void calculaTotales() {
        ...
        this.importeTotal = 0;
        for (DetalleVender item : nuevaVenta.getDetallesVenta()) {
