...
public class Usuario1 {
	...
	private StringProperty avenida;
	...
	public Usuario1(){
		setNombre_usuario(contrasenia =nombre= apellido_paterno= apellido_materno= calle= avenida= numero= colonia= ciudad= telefono = email= tipo =new SimpleStringProperty());
	...
	public ObservableList<Usuario1> getUsuarios1(boolean estatus) throws SQLException{
		...
		try {
			...
			while(rs.next()){
				...
				u.setNombre_usuario(new SimpleStringProperty(rs.getString("nombre_usuario")));
	...
	*/
	...
	public StringProperty getNombre_usuario() {
